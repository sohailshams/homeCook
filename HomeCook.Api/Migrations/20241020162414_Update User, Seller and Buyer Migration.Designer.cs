...
namespace HomeCook.Api.Migrations
{
    ...
    [Migration("20241020162414_Update User, Seller and Buyer Migration")]
    partial class UpdateUserSellerandBuyerMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ShareYourFood.Api.Models.Recipe", b =>
                {
                    ...
                    b.HasOne("ShareYourFood.Api.Models.RecipeImage", "RecipeImage")
                        .WithMany()
